...
namespace RetailStore.Data.Migrations
{
    ...
    [Migration("20190906121525_AddedCutmerSaleOrderAndSaleOrderDetail")]
    partial class AddedCutmerSaleOrderAndSaleOrderDetail
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RetailStore.Domain.Customer", b =>
                {
            ...
            modelBuilder.Entity("RetailStore.Domain.SaleOrder", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("RetailStore.Domain.SaleOrderDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("RetailStore.Domain.SaleOrder", b =>
                {
                    b.HasOne("RetailStore.Domain.Customer", "Customer")
                        .WithMany()
            ...
            modelBuilder.Entity("RetailStore.Domain.SaleOrderDetail", b =>
                {
                    ...
                    b.HasOne("RetailStore.Domain.SaleOrder", "SaleOrder")
